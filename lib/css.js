        ...
        function (next) {
          ...
          async.reduce(
            ...
            function (memo, key, cb) {
              var file = files[key];
              if (!file) return cb(new Error('Could not find stylesheet for key: ' + key));
