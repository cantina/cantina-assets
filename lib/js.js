  ...
  if (conf[namespace].aggregate) {
    ...
    async.series([
      ...
      function (next) {
        ...
        var exclude = conf[namespace].exclude;
        if (exclude) {
      ...
      function (next) {
        ...
        app.assets.js[namespace].contents = content;
        next();
      }
    ], function (err) {
      if (err) return cb(err);
...
exports.minify = function minify (namespace, cb) {
  if (conf[namespace].minify) {
    ...
    app.assets.js[namespace].contents = uglify.minify(app.assets.js[namespace].contents, {
      fromString: true,
      mangle: {
...
exports.serve = function serve (namespace, cb) {
  if (conf[namespace].serve) {
    // console.log(app.assets.js[namespace]);
    console.log('- serving ' + namespace + ' js ...');
    app.middleware.get(-1200, '/assets/js/' + app.assets.js[namespace].hash + '-' + namespace + '.js', dish(app.assets.js[namespace].contents, {
      headers: {
